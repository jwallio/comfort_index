"""Composition of hourly nice-weather scores."""

from __future__ import annotations

import xarray as xr

from nicewx.config import HOURLY_REQUIRED_FIELDS
from nicewx.scoring.air_quality import score_optional_air_quality
from nicewx.scoring.clouds import score_clouds
from nicewx.scoring.hazards import hazard_cap, hazard_penalty
from nicewx.scoring.humidity import score_dewpoint
from nicewx.scoring.interactions import total_interaction_adjustment
from nicewx.scoring.precip import score_precipitation
from nicewx.scoring.temperature import score_temperature
from nicewx.scoring.wind import score_wind
...
def score_hourly_dataset(dataset: xr.Dataset) -> xr.Dataset:
    ...
    scored["hourly_score"].attrs["long_name"] = "Hourly nice weather score"
