"""Static map rendering for nice weather outputs."""
...
from nicewx.mapping.smoothing import smooth_field
from nicewx.scoring.categories import category_colors, category_labels
...
def _continuous_score_cmap(colors: tuple[str, ...]) -> LinearSegmentedColormap:
    return LinearSegmentedColormap.from_list("nicewx_score", colors)
