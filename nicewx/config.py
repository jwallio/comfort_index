"""Shared configuration for the nice weather scoring engine."""
...
STITCHED_CONUS_STATE_FILE: Final[Path] = PROJECT_ROOT / "nicewx" / "mapping" / "data" / "us_states.geojson"
...
MAP_TITLE_TEMPLATE: Final[str] = "Nice Weather Outlook"
MAP_SUBTITLE_TEMPLATE: Final[str] = "Daily outdoor pleasantness score and category"
PRODUCT_METADATA: Final[dict[str, str]] = {
    "product_title": "Nice Weather Outlook",
    "subtitle_source_line": "Daily outdoor pleasantness score from normalized hourly forecast fields",
    "credit_line": "Weather Projects Lab",
    "branding_footer": "Nice Weather Map Generator",
}
...
PRESENTATION_PLOT_STYLE: Final[dict[str, str | float | int]] = {
    ...
    "stitched_subtitle_y": 0.952,
    "stitched_source_y": 0.952,
    "stitched_margin_top": 0.9,
    ...
    "stitched_legend_title": "Daily Categories",
    "stitched_legend_bbox_x": 0.012,
    "stitched_legend_bbox_y": 0.018,
    "stitched_legend_ncol": 2,
    "stitched_colorbar_label": "Daily outdoor comfort score (0-100)",
    ...
    "shareable": {
        ...
        "plot_style": {
            **PRESENTATION_PLOT_STYLE,
            "figure_facecolor": "#f6f1e7",
            "axes_facecolor": "#fbf7ef",
            "title_color": "#161a1e",
            "subtitle_color": "#46505a",
            "border_color": "#656b70",
            "coastline_color": "#30353a",
            "state_color": "#8a908f",
            "legend_facecolor": "#f7f1e5",
            "legend_edgecolor": "#beb6a8",
        },
    },
    "public": {
        "raw_score_colors": (
...
ARCHIVE_SETTINGS: Final[dict[str, str]] = {
    ...
    "run_index_base_name": "nicewx_archive_index",
}
...
WESTERN_FAIR_NICE_DISTRIBUTION_RANGE: Final[tuple[float, float]] = (35.0, 55.0)
WESTERN_FAIR_NICE_FOCUS_WINDOWS: Final[tuple[tuple[float, float], ...]] = (
    (40.0, 50.0),
    (42.0, 48.0),
)
WESTERN_FAIR_NICE_BORDERLINE_MARGIN: Final[float] = 2.0
WESTERN_FAIR_NICE_DIAGNOSTIC_THRESHOLDS: Final[tuple[float, ...]] = (
    43.0,
    45.0,
    47.0,
)
