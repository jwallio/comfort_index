...
from nicewx.validation.inspection import inspect_point
from nicewx.validation.mismatch_audit import audit_point_mismatch
from nicewx.validation.real_world_cases import DEFAULT_REAL_WORLD_CASES, RealWorldCase
...
def main() -> None:
    ...
    output_path = output_dir / f"nicewx_real_world_validation_{output_stem}.csv"
    mismatch_output_path = output_dir / f"nicewx_real_world_validation_mismatches_{output_stem}.csv"
