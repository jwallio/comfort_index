...
from nicewx.main import _build_regional_daily
from nicewx.mapping.mosaic import RegionalDailyRaster, build_common_target_grid, build_regional_weight_field, mosaic_regional_rasters
...
def run_western_seam_attribution(
    ...
    summary_path = output_dir / f"nicewx_western_seam_attribution_{mesh_profile}{aggregation_suffix}_{valid_date:%Y%m%d}.csv"
    detail_path = output_dir / f"nicewx_western_seam_attribution_overlap_cells_{mesh_profile}{aggregation_suffix}_{valid_date:%Y%m%d}.csv"
