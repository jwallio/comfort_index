...
from nicewx.validation.demo_cases import run_demo_case_validation
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run the nice-weather demo calibration cases.")
