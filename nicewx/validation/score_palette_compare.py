...
from nicewx.config import OUTPUT_DIR, STITCHED_CONUS_PRESENTATION
from nicewx.mapping.plotting import plot_raw_score_map
...
def _default_daily_fields_path(valid_date: datetime.date) -> Path:
    return (
        OUTPUT_DIR
        / f"nicewx_mosaic_west_coast_southwest_rockies_plains_southeast_northeast_great_lakes_openmeteo_daily_fields_{valid_date:%Y%m%d}.nc"
    )
