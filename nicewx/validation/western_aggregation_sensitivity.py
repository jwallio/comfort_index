...
def run_western_aggregation_sensitivity(
    ...
    summary_path = output_dir / f"nicewx_western_aggregation_sensitivity_{mesh_profile}_{valid_date:%Y%m%d}.csv"
    ...
    comparison_path = output_dir / f"nicewx_western_aggregation_sensitivity_diff_{mesh_profile}_{valid_date:%Y%m%d}.csv"
