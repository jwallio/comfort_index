...
OPENMETEO_VERIFICATION_FORECAST_MODEL_ECMWF_IFS_HRES: Final[str] = "ecmwf_ifs"
OPENMETEO_VERIFICATION_FORECAST_MODEL_ECMWF_IFS_025: Final[str] = "ecmwf_ifs025"
OPENMETEO_VERIFICATION_FORECAST_MODEL_NWS_NDFD_HOURLY: Final[str] = "nws_ndfd_hourly"
OPENMETEO_VERIFICATION_FORECAST_MODEL_NWS_NDFD_GFS_BLEND: Final[str] = "nws_ndfd_gfs_blend"
OPENMETEO_VERIFICATION_FORECAST_MODEL_NWS_NDFD_CLOUD_BLEND: Final[str] = "nws_ndfd_cloud_blend"
OPENMETEO_VERIFICATION_FORECAST_MODEL_NWS_NDFD_THERMAL_CLOUD_BLEND: Final[str] = "nws_ndfd_thermal_cloud_blend"
OPENMETEO_VERIFICATION_FORECAST_MODEL_NWS_NDFD_SURFACE_BLEND: Final[str] = "nws_ndfd_surface_blend"
OPENMETEO_VERIFICATION_NDFD_BLEND_FIELDS: Final[dict[str, tuple[str, ...]]] = {
    OPENMETEO_VERIFICATION_FORECAST_MODEL_NWS_NDFD_GFS_BLEND: ("temp_f", "dewpoint_f", "wind_mph", "gust_mph", "cloud_pct", "pop_pct"),
    OPENMETEO_VERIFICATION_FORECAST_MODEL_NWS_NDFD_CLOUD_BLEND: ("cloud_pct",),
    OPENMETEO_VERIFICATION_FORECAST_MODEL_NWS_NDFD_THERMAL_CLOUD_BLEND: ("temp_f", "dewpoint_f", "cloud_pct"),
    OPENMETEO_VERIFICATION_FORECAST_MODEL_NWS_NDFD_SURFACE_BLEND: ("temp_f", "dewpoint_f", "cloud_pct", "gust_mph"),
}
OPENMETEO_VERIFICATION_NDFD_BLEND_SOURCE_LABELS: Final[dict[str, str]] = {
    OPENMETEO_VERIFICATION_FORECAST_MODEL_NWS_NDFD_GFS_BLEND: "NWS NDFD + GFS Blend",
    OPENMETEO_VERIFICATION_FORECAST_MODEL_NWS_NDFD_CLOUD_BLEND: "NWS NDFD Cloud + GFS Blend",
    OPENMETEO_VERIFICATION_FORECAST_MODEL_NWS_NDFD_THERMAL_CLOUD_BLEND: "NWS NDFD Thermal/Cloud + GFS Blend",
    OPENMETEO_VERIFICATION_FORECAST_MODEL_NWS_NDFD_SURFACE_BLEND: "NWS NDFD Surface + GFS Blend",
}
...
NOAA_ANALYSIS_OBSERVED_PRECIP_QPF_MIN_IN: Final[float] = 0.001
