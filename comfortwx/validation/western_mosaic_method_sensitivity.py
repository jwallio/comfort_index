...
def run_western_mosaic_method_sensitivity(
    ...
    summary_path = output_dir / f"comfortwx_western_mosaic_method_sensitivity_{mesh_profile}_{valid_date:%Y%m%d}.csv"
    ...
    comparison_path = output_dir / f"comfortwx_western_mosaic_method_diff_{mesh_profile}_{valid_date:%Y%m%d}.csv"
