...
def run_western_mesh_sensitivity(valid_date: date, output_dir: Path) -> tuple[Path, Path]:
    ...
    profile_summary_path = output_dir / f"comfortwx_western_mesh_sensitivity_{valid_date:%Y%m%d}.csv"
    ...
    comparison_path = output_dir / f"comfortwx_western_mesh_sensitivity_diff_{valid_date:%Y%m%d}.csv"
