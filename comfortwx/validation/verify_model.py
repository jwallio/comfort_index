...
def _verification_summary(
    *,
    ...
    summary = {
        ...
        "forecast_source": str(metadata.get("forecast_source_label", f"Open-Meteo Previous Runs ({metadata['forecast_model']})")),
        "analysis_source": str(metadata.get("analysis_source_label", str(metadata["analysis_model"]).replace("_", " "))),
