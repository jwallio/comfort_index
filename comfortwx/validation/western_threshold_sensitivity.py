...
from comfortwx.config import CATEGORIES, OUTPUT_DIR, WESTERN_THRESHOLD_MARGIN_DIAGNOSTIC, WESTERN_THRESHOLD_PROXIMITY_BINS
from comfortwx.validation.western_aggregation_sensitivity import run_western_aggregation_sensitivity
...
def run_western_threshold_sensitivity(
    ...
    summary_path = output_dir / f"comfortwx_western_threshold_sensitivity_{mesh_profile}_{valid_date:%Y%m%d}.csv"
    detail_path = output_dir / f"comfortwx_western_threshold_flip_detail_{mesh_profile}_{valid_date:%Y%m%d}.csv"
